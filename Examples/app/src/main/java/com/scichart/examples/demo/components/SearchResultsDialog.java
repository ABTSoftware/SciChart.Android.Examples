...
public class SearchResultsDialog extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    public void setData(SearchResultsDataAdapter dataAdapter) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        final ExampleSearchView selectedExample = (ExampleSearchView) resultsList.getAdapter().getItem(position);
