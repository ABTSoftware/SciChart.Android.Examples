...
//
// CylindroidMesh3DChartFragment.kt is part of SCICHART®, High Performance Scientific Charts
...
class CylindroidMesh3DChartFragment: ExampleBaseFragment<ExampleCreateFreeSurface3dFragmentBinding>() {
        ...
        binding.surface3d.suspendUpdates {
            ...
            renderableSeries {
                freeSurfaceRenderableSeries3D {
                    val random = Random()
                    cylindroidDataSeries3D<Double, Double>(sizeU, sizeV) {
                        a = 3.0
                        b = 3.0
                        h = 7.0
