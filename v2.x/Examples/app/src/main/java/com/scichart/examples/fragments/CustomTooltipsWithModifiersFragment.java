...
public class CustomTooltipsWithModifiersFragment extends ExampleBaseFragment {
    ...
    private static final String ROLLOVER_MODIFIER = "RolloverModifier";
    private static final String CURSOR_MODIFIER = "CursorModifier";
    private static final String TOOLTIP_MODIFIER = "TooltipModifier";
    ...
    private static class FirstCustomSeriesInfoProvider extends DefaultXySeriesInfoProvider {
        @Override
        protected ISeriesTooltip getSeriesTooltipInternal(Context context, XySeriesInfo seriesInfo) {
            return new FirstCustomXySeriesTooltip(context, seriesInfo, TOOLTIP_MODIFIER);
        }

        @Override
        protected ISeriesTooltip getRolloverTooltipInternal(Context context, XySeriesInfo<? extends XyRenderableSeriesBase> seriesInfo) {
            return new FirstCustomXySeriesTooltip(context, seriesInfo, ROLLOVER_MODIFIER);
        }
    ...
    private static class SecondCustomSeriesInfoProvider extends DefaultXySeriesInfoProvider {
        ...
        @Override
        protected ISeriesTooltip getSeriesTooltipInternal(Context context, XySeriesInfo seriesInfo) {
            return new SecondCustomXySeriesTooltip(context, seriesInfo, TOOLTIP_MODIFIER);
        }

        @Override
        protected ISeriesTooltip getRolloverTooltipInternal(Context context, XySeriesInfo<? extends XyRenderableSeriesBase> seriesInfo) {
            return new SecondCustomXySeriesTooltip(context, seriesInfo, ROLLOVER_MODIFIER);
        }
