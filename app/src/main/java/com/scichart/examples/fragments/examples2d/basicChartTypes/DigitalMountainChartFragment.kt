...
//
// DigitalMountainChartFragment.kt is part of SCICHART®, High Performance Scientific Charts
...
class DigitalMountainChartFragment : ExampleSingleChartBaseFragment() {
