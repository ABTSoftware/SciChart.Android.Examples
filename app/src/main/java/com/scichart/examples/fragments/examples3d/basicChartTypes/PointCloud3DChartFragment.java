...
//
// CreatePointCloud3DChartFragment.java is part of SCICHART®, High Performance Scientific Charts
...
public class PointCloud3DChartFragment extends ExampleSingleChart3DBaseFragment {
    @Override
