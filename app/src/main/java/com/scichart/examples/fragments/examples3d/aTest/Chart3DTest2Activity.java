...
//
// Chart3DTest2Activity.java is part of SCICHART®, High Performance Scientific Charts
...
public class Chart3DTest2Activity extends AppCompatActivity {

    private SciChart3DBuilder sciChart3DBuilder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sciChart3DBuilder = SciChart3DBuilder.instance();
        ...
        final SciChartSurface3D surface3d = findViewById(R.id.surface3d);
        initChart(surface3d);
    }

    private void initChart(SciChartSurface3D surface3d) {
        ...
        for (int i = 0; i < 1000; i++) {
            final double x = dataManager.getGaussianRandomNumber(10, 2);
            final double y = dataManager.getGaussianRandomNumber(10, 2);
            final double z = dataManager.getGaussianRandomNumber(10, 2);

            dataSeries.append(x, y, z);
        }

        final EllipsePointMarker3D pointMarker3D = sciChart3DBuilder.newEllipsePointMarker3D()
                .withFill(0xFFFF5722) // orange accent color
                .withSize(3f)
                .build();
